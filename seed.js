...
var albums_list = [
  {
    ...
    songs: ['Overdue', 'Stay Gone', 'Let the Reigns Go Loose', 'Fall From Grace', 'Grunge Pig', 'High as the Moon', 'All That I Know', 'Walking on a Wire', 'Wish You Were Here', 'Campfire Kansas', 'The Worst Idea', 'Hannah Hold On']
  },
  {
    title: 'OK Computer',
    artist: 'Radiohead',
  ...
  var artists_list = [
    ...
    {
      name: 'Radiohead',
      members: ['Thom Yorke', 'Philip Selway', 'John Greenwood', 'Ed OBrien', 'Colin Greenwood']
    },
    {
      name: 'Kendrick Lamar',
